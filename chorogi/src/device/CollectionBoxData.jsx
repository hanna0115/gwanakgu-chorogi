...
const BatteriesFluorescentlights = {
  ...
  detailSlug : 'Batteries-Fluorescent-lights-detail',
...
const circleIcon = '/images/circle-icon.PNG';
const xIcon = '/images/x-icon.PNG';
const questionIcon = '/images/question-icon.PNG';
...
const collectionBoxDetailData = [
  {
    ...
    subIcon1 : circleIcon,
    subTitle1 : '넣어도 돼요!',
    subContent1 : '의류, 신발, 일반가방, 담요, 누비이불, 커튼, 카펫 등오물이 묻지 않은 것을 넣어주세요.',
    subIcon2 : xIcon,
    subTitle2 : '넣으면 안돼요!',
  ...
  },
  {
    ...
    mainContent : '폐건전지는 인체에 해로운 납, 수은, 카드뮴 등 중금속이 들어 있기 때문에 매립하거나 소각할 경우 대기오염과 토양오염의 원인이 돼요.제대로 수거하면 철·아연·은·니켈 등 유용한 금속을 얻을 수 있어요.',
    subIcon1 : questionIcon,
    subTitle1 : '분리배출 어떻게 하나요?',
    subContent1 : '녹슬지 않게 물기를 제거하고, 원상태로 전용 수거함에 배출해요.',
    subIcon2 : xIcon,
    subTitle2 : '분리배출 안돼요!',
    subContent2 : '시계에 사용하는 단추형 건전지는 산화 은전지로 시계 판매점을 통해 배출하는 것이 좋아요. 판매점에서 교체하면 여기서 다 쓴건전지를 모아 재활용 업체로 보내요.'
  },
  {
    menu : '수거함 위치 알리미',
    ...
    mainContent : '폐형광등은 망간, 아연, 수은 등 유해물질이 포함되어 있어 일반쓰레기와 함께 처리시환경 오염을 일으켜요.',
    subIcon1 : questionIcon,
    subTitle1 : '분리배출 어떻게 하나요?',
    subContent1 : '포장을 벗기고 모양별로 구분한 후 깨지지 않게주의하며 전용 수거함에 배출해요.',
    subIcon2 : xIcon,
    subTitle2 : '분리배출 안돼요!',
    subContent2 : '깨진 형광등 : 신문지등으로 잘 싸서 종량제봉투에 배출해요.\n형광물질이 들어 있지 않은 LED와 백열전구 : 재활용품이 아니므로 신문지 등으로 싸서 종량제봉투에 배출해요.'
  },
  {
    menu : '수거함 위치 알리미',
    title : '분리수거하고 돈벌기 ',
    ...
    mainContent : '네프론은 우리 몸 콩팥에 있는 가장 작은 단위에요. 콩팥이 우리 몸의 혈액을 깨끗하게 정화하듯이,수퍼빈의 네프론은 우리 주변의 쓰레기를 수집하고 재활용하여 세상을 깨끗하게 하는 역할을 수행해요. 네프론에 재활용 가능한 쓰레기를 투입하면환경을 지키고 금전적 보상까지 얻을 수 있어요.',
    subIcon1 : circleIcon,
    subTitle1 : '넣어도 돼요!',
    subContent1 : '투명하고 색이 없는 음료 페트병 내용물이 없는 음료 캔\n＊안쪽, 바깥쪽 모두 깨끗하게 씻어주세요. 깨끗할수록 재활용이 더욱 잘 돼요!',
    subIcon2 : xIcon,
    subTitle2 : '넣으면 안돼요!',
    subContent2 : '- 페트병이지만 투입하면 안되는 용기들 : 샴푸용기, 어린이 음료병, 유색페트\n- 일회용 컵 캔이지만 투입하면 안되는 용기들:  부탄가스, 스프레이 용기, 통조림 캔'
  },
  {
    menu : '수거함 위치 알리미',
    title : '가까운 곳에 기부하기',
    ...
    mainContent : '물품을 만들기 위해서는 연료와 여러 가지 화학 물질이 사용되고 물품의 쓰임이 다해져 없어져야 할 때도 큰 오염을 낳아요.우리가 사용하는 생활 용품을 아껴 쓰면 그만큼 물품을 적게 만들 수 있을 거에요. 이와 같은 실천이 불필요한 자원의 낭비를 막고, 환경 오염에 큰 도움이 될 거에요.',
    subIcon1 : questionIcon,
    subTitle1 : '기증한 물품, 어떻게 쓰이나요?',
    subContent1 : '기증된 물건은 장애근로인들이 분류, 가격표 붙이기, 진열등의 과정을 통해 굿윌스토어매장에서 판매가 되며 그 수익으로 장애 근로인들에게 최저임금을 지급하고 있어요.',
    subIcon2 : circleIcon,
    subTitle2 : '기증 가능해요!',
    subContent2 : '대형 가구나 설치가 필요한 전자제품, 오래된 아동 전집, 큰 플라스틱 장난감, 사용한 침구, 속옷 이외에는 모두 기증 가능해요. 그 중 고장 나지 않고 오염되지 않은 물품으로 기증해주세요.'
  }
]
